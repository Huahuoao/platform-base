...
insert ignore into network_server_info (server_protocol, server_addr, server_port, identifier, extra, created_at,
                                        updated_at)
values ('tls', 'network server poblic domain', 0, 'network server inner address', '', now(), now());
